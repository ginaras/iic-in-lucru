...
public class Investitii {
    ...
    public static String USERr=  "root";//ControllerStage01AdminMySQL.USER_SQL;
    public static String USER=  "investitii";//ControllerStage01AdminMySQL.USER_SQL;
    public static String PASSWORDr=  "root";//ControllerStage01AdminMySQL.PASS_SQL;
    public static String PASSWORD=  "pas@inv2gyn";//ControllerStage01AdminMySQL.PASS_SQL;
    public static String REVOKE = "REVOKE ALL PRIVILEGES ON invDB.* FROM 'root'@'localhost'";
...
//    public static String URL = String.format( "jdbc:mysql://localhost:3306/%s?useLegacyDateTimeCode=false&serverTimezone=GMT","invDB" );
    ...
    public static final String CREATE_TABLE_BUGET_PROJ = "CREATE TABLE IF NOT EXISTS bugetPROJ (nrCrt INT(5) AUTO_INCREMENT PRIMARY KEY, nrProiect CHAR(20), denProiect CHAR(200), startProiect DATE, valInitiala VARCHAR(20), valRectificare VARCHAR(20) NOT NULL, valFinala VARCHAR(20), respProiect VARCHAR(50))";
    public static final String CREATE_TABLE_BUGET_CONTRACT = "CREATE TABLE IF NOT EXISTS bugetCONTRACT (nrCrt INT(5) AUTO_INCREMENT PRIMARY KEY, furnizor CHAR(100), CUIfurnizor CHAR(14), adresa CHAR (100), nrContract CHAR(25),dataContract DATE,valInitiala VARCHAR(20), valRectificare VARCHAR(20) NOT NULL, valFinala VARCHAR(20) )";
